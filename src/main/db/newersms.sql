...
-- --------------------------------------------------
-- Spring boot 2.0.1 + MySQL 5.7.18
-- newersms: Newer Student Manager System
-- 牛耳学员管理系统
-- Create by SONG 2018-05-04 14:20
-- --------------------------------------------------
...
-- show databases;
-- 创建数据库
-- create database if not exists NEWERSMS;
...
-- newer666
insert into SYS_USERS (id, USERNAME, password, email, status, last_password_reset_date, campus, photo_path)
values (2, 'huping', '$2a$10$hKcJ7UQ55uPHxen01nKrausGdRkysXcx1yw/2N9UAtNu.rhV5XFpa','36783340@qq.com', '1', now(),'W,L,S','胡平.jpg');

insert into SYS_USERS (id, USERNAME, password, email, status, last_password_reset_date, campus, photo_path)
values (3, 'jiangyiming', '$2a$10$hKcJ7UQ55uPHxen01nKrausGdRkysXcx1yw/2N9UAtNu.rhV5XFpa','283213328@qq.com', '1', now(),'W','蒋义铭.jpg');
insert into SYS_USERS (id, USERNAME, password, email, status, last_password_reset_date, campus, photo_path)
values (4, 'lihongfang', '$2a$10$hKcJ7UQ55uPHxen01nKrausGdRkysXcx1yw/2N9UAtNu.rhV5XFpa','3868006@qq.com', '1', now(),'W','李宏芳.jpg');
insert into SYS_USERS (id, USERNAME, password, email, status, last_password_reset_date, campus, photo_path)
values (5, 'chenjiulong', '$2a$10$hKcJ7UQ55uPHxen01nKrausGdRkysXcx1yw/2N9UAtNu.rhV5XFpa','983318342@qq.com', '1', now(),'L,S','陈九龙.jpg');
insert into SYS_USERS (id, USERNAME, password, email, status, last_password_reset_date, campus, photo_path)
values (6, 'zoubin', '$2a$10$hKcJ7UQ55uPHxen01nKrausGdRkysXcx1yw/2N9UAtNu.rhV5XFpa','58113274@qq.com', '1', now(),'S','邹斌.jpg');

insert into SYS_USERS (id, USERNAME, password, email, status, last_password_reset_date, campus, photo_path)
values (7, 'fumeili', '$2a$10$hKcJ7UQ55uPHxen01nKrausGdRkysXcx1yw/2N9UAtNu.rhV5XFpa','342370295@qq.com', '1', now(),'W','付美丽.jpg');
insert into SYS_USERS (id, USERNAME, password, email, status, last_password_reset_date, campus, photo_path)
values (8, 'lihuimin', '$2a$10$hKcJ7UQ55uPHxen01nKrausGdRkysXcx1yw/2N9UAtNu.rhV5XFpa','568910645@qq.com', '1', now(),'L','黎慧敏.jpg');
insert into SYS_USERS (id, USERNAME, password, email, status, last_password_reset_date, campus, photo_path)
values (9, 'yangcune', '$2a$10$hKcJ7UQ55uPHxen01nKrausGdRkysXcx1yw/2N9UAtNu.rhV5XFpa','songxowe@qq.com', '1', now(),'S','杨存娥.jpg');

insert into SYS_USERS (id, USERNAME, password, email, status, last_password_reset_date, campus, photo_path)
values (10, 'suyang', '$2a$10$hKcJ7UQ55uPHxen01nKrausGdRkysXcx1yw/2N9UAtNu.rhV5XFpa','634280303@qq.com', '1', now(),'W','苏杨.jpg');
insert into SYS_USERS (id, USERNAME, password, email, status, last_password_reset_date, campus, photo_path)
values (11, 'wujia', '$2a$10$hKcJ7UQ55uPHxen01nKrausGdRkysXcx1yw/2N9UAtNu.rhV5XFpa','2323339125@qq.com', '1', now(),'W','吴佳.jpg');
insert into SYS_USERS (id, USERNAME, password, email, status, last_password_reset_date, campus, photo_path)
